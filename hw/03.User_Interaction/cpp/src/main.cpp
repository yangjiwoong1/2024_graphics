...
void compose_imgui_frame()
{
  ...
  // control window
  {
    ...
    ImGui::SliderFloat3("scale", &g_vec_model_scale[0], 0.1f, 2.0f);
...
void set_transform() 
{
  ...
  g_mat_model = glm::translate(g_vec_model_translate)*glm::mat4_cast(g_quat_model_rotation)*glm::scale(g_vec_model_scale);
}
